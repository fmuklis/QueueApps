...
-- =============================================
CREATE PROCEDURE [queue].[spOutpatient_GetCurrentQueue]
...
BEGIN
	...
	SELECT [b].[QueueId], [c].TypeName, bb.CounterName, [b].[DateOfQueue]
	 ...
	 WHERE a.ServiceCategoryId = 1/*Pendaftaran Rawat Jalan*/ AND b.QueueStatusId = 3/*Sedang Dilayani*/
	       AND b.CounterId = @counterId AND a.TypeId = @typeId AND b.DateOfQueue = @dateOfQueue;
