...
-- =============================================
CREATE FUNCTION [dbo].[calculator_totalTagihanGawatDarurat]
(
...
BEGIN
	...
	SELECT @hargaJual = ISNULL(b.totalBiayaPerawatan, 0) + ISNULL(c.totalBiayaBhp, 0) + ISNULL(d.totalBiayaResep, 0)
					  - a.diskonTunai 
					  - ((ISNULL(b.totalBiayaPerawatan, 0) + ISNULL(c.totalBiayaBhp, 0) + ISNULL(d.totalBiayaResep, 0) - a.diskonTunai) * a.diskonPersen / 100)
