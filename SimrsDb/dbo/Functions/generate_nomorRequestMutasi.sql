...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE FUNCTION [dbo].[generate_nomorRequestMutasi]
(
...
BEGIN
	...
	SELECT @suffix = '/RSUD-OKI/FRM-RQMT/'+ dbo.generate_roman(MONTH(@tanggalOrder)) +'/'+ CAST(YEAR(@tanggalOrder) AS varchar(10));
	...
	INSERT INTO @listNumberOrder
	     SELECT TOP 100 
		  ...
		  WHERE YEAR(tanggalOrder) = YEAR(@tanggalOrder) AND MONTH(tanggalOrder) = MONTH(@tanggalOrder) AND LEN(nomorOrder) > 4
