...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE FUNCTION [dbo].[generate_kodeMutasiBhp]
(
...
BEGIN
	...
	SELECT @suffix = '/RSUD-OKI/FRM-MBHP/'+ dbo.generate_roman(MONTH(@tanggalAprove)) +'/'+ CAST(YEAR(@tanggalAprove) AS varchar(10));
