...
-- =============================================
CREATE PROCEDURE [dbo].[radiologi_pemeriksaan_entryTindakan_delete_pemeriksaan]
...
BEGIN
	...
	IF EXISTS(SELECT 1 FROM dbo.transaksiOrder WHERE idOrder = @idOrder AND idStatusOrder <> 2)
		BEGIN
			SELECT 'Tidak Dapat Dihapus, Pemeriksaan Radiologi '+ b.caption AS respon, 0 AS responCode
