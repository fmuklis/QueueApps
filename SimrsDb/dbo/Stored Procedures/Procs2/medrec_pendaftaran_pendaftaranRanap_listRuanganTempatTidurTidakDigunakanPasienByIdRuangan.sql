...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[medrec_pendaftaran_pendaftaranRanap_listRuanganTempatTidurTidakDigunakanPasienByIdRuangan]
...
BEGIN
	...
	SELECT a.idTempatTidur, a.noTempatTidur
	 ...
	 WHERE a.idRuanganRawatInap = @idRuanganRawatInap AND a.flagMasihDigunakan = 1/*True*/ AND b.idPendaftaranPasienDetail IS NULL
END