...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[transaksiTindakanRadioInsert]
...
BEGIN
	...
	Declare @idJenisBilling Int = Case
									   ...
									   Else 4/*Billing Tagihan Radiologi*/
								  End
	SET NOCOUNT ON;

    -- Insert statements for procedure here
	Begin Try
		Begin Tran tranzTindakanRadioInsert7565;
		...
		If Not Exists(Select 1 From dbo.transaksiTindakanPasien Where idOrderDetail = @idOrderDetail)
			...
			End
			Commit Tran tranzTindakanRadioInsert7565;
			Select 'Data Berhasil Disimpan' As respon, 1 As responCode;
		End Try
		Begin Catch
			Rollback Tran tranzTindakanRadioInsert7565;
