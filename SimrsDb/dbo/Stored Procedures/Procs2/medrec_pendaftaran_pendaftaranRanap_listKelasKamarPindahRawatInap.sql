...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[medrec_pendaftaran_pendaftaranRanap_listKelasKamarPindahRawatInap] 
...
BEGIN
	...
	SELECT namaKelas, idKelas
	 ...
	 WHERE idKelas IN(@idKelasPenjamin, @idKelas) OR (pelayanan = 1 AND penjamin = 0)
END