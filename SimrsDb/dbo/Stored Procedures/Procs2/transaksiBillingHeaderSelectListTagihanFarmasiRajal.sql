...
-- =============================================
CREATE PROCEDURE [dbo].[transaksiBillingHeaderSelectListTagihanFarmasiRajal]
...
BEGIN
	...
	/*SELECT a.[idPenjualanHeader]
	 ...
	 WHERE ca.idJenisBilling = 3/*Billing Farmasi*/ And ca.idJenisBayar Is Null And c.idPendaftaranPasien = @idPendaftaranPasien
