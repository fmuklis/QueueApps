...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE operasi_tindakan_entryTindakan_addImf
...
BEGIN
	...
	Else
		Begin
			Select 'Permintaan IMF Ke '+ namaJenisStok +' Dengan Dokter '+ c.NamaOperator +' Telah Terdaftar, Tidak Perlu Diorder Lagi' As respon, 0 As responCode
