...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[transaksiOrderDeleteForOrderRadiologiPasienLuar]
...
BEGIN
	...
	If Exists(Select 1 From dbo.transaksiOrderDetail a
		...
		Begin
			Select 'Tidak Dapat Dihapus, Pemeriksaan Radiologi Telah Dibayar' As respon, 0 As responCode;
		End
	Else
		Begin Try
			/*Transaction Begin*/
