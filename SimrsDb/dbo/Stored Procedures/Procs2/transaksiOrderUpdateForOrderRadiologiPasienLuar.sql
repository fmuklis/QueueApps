...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[transaksiOrderUpdateForOrderRadiologiPasienLuar]
...
BEGIN
	...
	If Exists(Select 1 From dbo.transaksiOrderDetail a
		...
		Begin
			Select 'Tidak Dapat Diedit, Pemeriksaan Radiologi Telah Dibayar' As respon, 0 As responCode;
		End
	Else
		Begin
			...
			/*Respon*/		   	
			Select 'Data Pemeriksaan Radiologi Berhasil Diupdate' As respon, 1 As responCode;								
		End
END