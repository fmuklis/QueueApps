...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[utdrs_pemeriksaanPasienLuar_entryPemeriksaanDetail_deletePemeriksaan]
...
BEGIN
	...
	DECLARE @idOrderDetail bigint = (SELECT idOrderDetail FROM dbo.transaksiTindakanPasien WHERE idTindakanPasien = @idTindakanPasien);
	...
	ELSE
		BEGIN TRY
			...
			/*Menghapus Tindakan*/
			DELETE dbo.transaksiOrderDetail
