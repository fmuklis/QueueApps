...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[utdrs_pemeriksaanPasienLuar_dashboard_editPemeriksaan]
...
BEGIN
	...
	If Exists(Select 1 From dbo.transaksiOrderDetail a
		...
		Begin
			Select 'Tidak Dapat Diedit, Pemeriksaan UTDRS Telah Dibayar' As respon, 0 As responCode;
		End
	Else
		Begin
			...
			/*Respon*/		   	
			Select 'Data Pemeriksaan UTDRS Berhasil Diupdate' As respon, 1 As responCode;								
		End
END