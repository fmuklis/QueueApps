...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[transaksiOrderSelectForListOrderLabPasienLuar]
...
BEGIN
	...
	SELECT a.idOrder, a.tglOrder, a.kodeOrder, b.nama, ba.namaJenisKelamin, b.tglLahir, b.alamat, b.tlp, b.dokter
	 ...
	 WHERE a.idRuanganTujuan = 21/*Laboratorium*/ And Convert(date, a.tglOrder) Between @periodeAwal And @periodeAkhir
  ORDER BY a.tglOrder;
END