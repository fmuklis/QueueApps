...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[utdrs_pemeriksaanPasienLuar_dashboard_batalValidasi]
...
BEGIN
	...
	If Exists(Select 1 From dbo.transaksiBillingHeader a
		...
		Begin
			Select 'Tidak Dapat Dibatalkan, Pemeriksaan UTDRS Telah Dibayar' As respon, 0 As responCode; 
		End
	Else
		Begin Try
			/*Transaction Begin*/
			...
			/*Respon*/
			Select 'Validasi Pemeriksaan UTDRS Berhasil Dibatalkan' As respon, 1 As responCode;
		End Try
		Begin Catch
