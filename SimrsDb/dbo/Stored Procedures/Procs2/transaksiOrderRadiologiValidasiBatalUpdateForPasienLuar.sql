...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[transaksiOrderRadiologiValidasiBatalUpdateForPasienLuar]
...
BEGIN
	...
	If Exists(Select 1 From dbo.transaksiBillingHeader a
		...
		Begin
			Select 'Tidak Dapat Dibatalkan, Pemeriksaan Radiologi Telah Dibayar' As respon, 0 As responCode; 
		End
	Else
		Begin Try
			/*Transaction Begin*/
			...
			/*Respon*/
			Select 'Validasi Pemeriksaan Radiologi Berhasil Dibatalkan' As respon, 1 As responCode;
		End Try
		Begin Catch
