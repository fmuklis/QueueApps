CREATE PROCEDURE [dbo].[medrec_pendaftaran_pendaftaranRajal_searchByIdPasien]
	@idPasien int
...
BEGIN
	...
	SELECT a.idPekerjaanPasien, a.anakKePasien, a.idPasien, a.kodePasien, b.noRM, a.gelarDepanPasien, a.namaLengkapPasien, a.gelarBelakangPasien, a.tempatLahirPasien, a.tglLahirPasien, a.namaAyahPasien, a.namaIbuPasien
		  ...
		  ,a.idWargaNegaraPasien, b.namaWargaNegara, b.namaStatusPerkawinan, a.idDokumenIdentitasPasien, b.namaDokumenIdentitas, fa.idJenisPenjaminInduk, fa.namaJenisPenjaminInduk
	  ...
	  FROM dbo.masterPasien a 
		   ...
		   Left Join  dbo.transaksiPendaftaranPasien c On c.idPasien = a.idPasien
				Left Join dbo.masterJenisPenjaminPembayaranPasien f On f.idJenisPenjaminPembayaranPasien = c.idJenisPenjaminPembayaranPasien
