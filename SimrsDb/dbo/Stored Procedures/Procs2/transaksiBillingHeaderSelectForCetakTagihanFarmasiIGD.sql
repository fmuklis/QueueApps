...
-- =============================================
CREATE PROCEDURE [dbo].[transaksiBillingHeaderSelectForCetakTagihanFarmasiIGD]
	...
	/*SELECT a.[idPenjualanHeader]
	  ...
	  FROM [dbo].[farmasiPenjualanHeader] a 
		   ...
		   Inner Join dbo.farmasiResep c On a.idResep = c.idResep
				...
				Inner Join dbo.transaksiBillingHeader cb On ca.tglBayar = cb.tglBayar And cb.idJenisBilling = 5/*Billing IGD*/
