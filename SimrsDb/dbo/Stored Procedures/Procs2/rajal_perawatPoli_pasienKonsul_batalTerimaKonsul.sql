...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
create PROCEDURE [dbo].[rajal_perawatPoli_pasienKonsul_batalTerimaKonsul]
...
BEGIN
	...
	If Exists (Select 1 From dbo.transaksiKonsul Where idTransaksiKonsul = @idTransaksiKonsul)
		Begin
			update dbo.transaksiKonsul set idStatusKonsul = 1  Where idTransaksiKonsul = @idTransaksiKonsul;
