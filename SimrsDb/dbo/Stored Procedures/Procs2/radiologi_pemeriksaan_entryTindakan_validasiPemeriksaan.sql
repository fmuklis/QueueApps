...
-- =============================================
CREATE PROCEDURE [dbo].[radiologi_pemeriksaan_entryTindakan_validasiPemeriksaan]
...
BEGIN
	...
	Else
		Begin Try
			...
			/*Update IdJenisBilling Tindakan*/
			UPDATE a
			   SET a.idJenisBilling = dbo.radiologi_generateIdJenisBilling(b.idOrder)
