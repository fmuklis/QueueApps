...
-- =============================================
CREATE PROCEDURE [dbo].[transaksiPemeriksaanLaboratoriumDelete]
...
BEGIN
	...
	/*DECLARE  @idTransaksi table(idOrderDetail int, idPendaftaranPasien int, idMasterTarif int);
		...
		Select a.idOrderDetail ,a.idPendaftaranPasien ,b.idMasterTarif  
		  From transaksiPemeriksaanLaboratorium a Inner Join transaksiOrderDetail b On a.idOrderDetail = b.idOrderDetail
