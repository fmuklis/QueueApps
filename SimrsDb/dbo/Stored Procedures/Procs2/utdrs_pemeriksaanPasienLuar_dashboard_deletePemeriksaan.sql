...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[utdrs_pemeriksaanPasienLuar_dashboard_deletePemeriksaan]
...
BEGIN
	...
	If Exists(Select 1 From dbo.transaksiOrderDetail a
		...
		Begin
			Select 'Tidak Dapat Dihapus, Pemeriksaan UTDRS Telah Dibayar' As respon, 0 As responCode;
		End
	Else
		Begin Try
			/*Transaction Begin*/
			...
			/*Respon*/		   	
			Select 'Data Pemeriksaan UTDRS Berhasil Dihapus' As respon, 1 As responCode;								
		End Try
		Begin Catch
			/*Rollback Commit*/
			Rollback Tran;
