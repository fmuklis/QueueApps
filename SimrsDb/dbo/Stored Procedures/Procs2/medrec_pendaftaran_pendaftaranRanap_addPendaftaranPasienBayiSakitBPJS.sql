...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[medrec_pendaftaran_pendaftaranRanap_addPendaftaranPasienBayiSakitBPJS]
...
BEGIn
	...
	Else
		Begin Try
			Begin Tran tranzInsertRawatInapBayi4534;
			/*Enrtry Data Bayi*/
			...
			Commit Tran tranzInsertRawatInapBayi4534;
			Select 'Data Pendaftaran Bayi Perinatal Berhasil Disimpan' AS respon, 1 AS responCode;
		End Try
		Begin Catch
			Rollback Tran tranzInsertRawatInapBayi4534;
