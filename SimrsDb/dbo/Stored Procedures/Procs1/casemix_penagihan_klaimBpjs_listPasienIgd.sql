...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE   PROCEDURE [dbo].[casemix_penagihan_klaimBpjs_listPasienIgd]
...
BEGIN
	...
	SELECT a.idPendaftaranPasien, c.penjamin, CAST(a.tglDaftarPasien AS DATE) AS tglDaftarPasien, CAST(a.tglKeluarPasien AS DATE) AS tglKeluarPasien, b.noRM, b.namaPasien, b.namaJenisKelamin, 
			b.umur, d.NamaOperator AS DPJP, e.namaRuangan, ISNULL(f.idStatusKlaim, 1/*Siap Klaim*/) AS idStatusKlaim, f.idBilling, b.tglLahirPasien, ISNULL(a.noSEPRawatJalan, '') AS noSEP
