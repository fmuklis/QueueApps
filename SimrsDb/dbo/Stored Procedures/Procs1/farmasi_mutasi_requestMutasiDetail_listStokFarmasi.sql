...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[farmasi_mutasi_requestMutasiDetail_listStokFarmasi]
...
BEGIN
    ...
    DECLARE @query nvarchar(max)
		   ,@idJenisStok tinyint = (SELECT idJenisStokAsal FROM dbo.farmasiMutasi WHERE idMutasi = @idMutasi)
	...
	SET @query = '
		SELECT a.idObatDosis, b.namaBarang, SUM(a.stok) AS stok, b.namaSatuanObat, jumlahData = COUNT(*) OVER()
		 ...
		 WHERE a.idJenisStok = @idJenStok AND a.tglExpired >= GETDATE() AND ISNULL(a.stok, 0) > 0 #dynamicHere#
