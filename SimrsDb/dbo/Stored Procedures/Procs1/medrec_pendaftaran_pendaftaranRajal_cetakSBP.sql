CREATE PROCEDURE [dbo].[medrec_pendaftaran_pendaftaranRajal_cetakSBP]
...
BEGIN
	...
	SELECT /*PASIEN*/
		   b.idPasien, b.noRM, b.kodePasien,namaPasien,b.Umur, b.namaPasien As namaLengkapPasien, b.tempatLahirPasien, b.tglLahirPasien, b.namaJenisKelamin, b.umur, b.namaPekerjaan, b.alamatPasien,namaDokumenIdentitas
		  ...
		  ,a.flagBerkasTidakLengkap, a.idDokter As DPJP, a.keluhan, g.diagnosaAwal, a.keteranganPendaftaran as keterangan, c.NamaOperator, ea.idJenisPenjaminPembayaranPasien, ea.namaJenisPenjaminPembayaranPasien
		  ...
		  ,Case
				...
				Else c.NamaOperator
		   End As operatorPoli
		  ,DateDiff(Day, a.tglDaftarPasien, Case
												 When a.tglKeluarPasien Is Null
													  Then GetDate()
												 Else a.tglKeluarPasien
											End) As lamaPerawatan
		  ,(Select Min(xa.tanggalMasuk)
			  From dbo.transaksiPendaftaranPasienDetail xa
			 Where a.idPendaftaranPasien = xa.idPendaftaranPasien) As tglDaftarRawatInap
