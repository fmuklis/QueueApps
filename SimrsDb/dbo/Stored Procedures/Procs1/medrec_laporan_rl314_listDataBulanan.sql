...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[medrec_laporan_rl314_listDataBulanan]
...
BEGIN
	...
	SELECT 'Bedah' AS jenisSpesialisasi, 100 AS rujukanPuskesmas, 10 AS rujukanBidan, 11 AS rujukanKlinik, 5 AS rujukanDokterSwasta
		  ,5 AS dirujukKeatas, 80 AS jumlahPasien, 6 AS pasienSisa, 1 AS meninggalDibawahDuaHari
