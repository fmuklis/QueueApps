...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[labor_petugasLabor_entryPemeriksaan_deletePemeriksaan]
...
BEGIN
	...
	IF EXISTS(SELECT 1 FROM dbo.transaksiOrder WHERE idOrder = @idOrder AND idStatusOrder <> 2)
		BEGIN
			SELECT 'Tidak Dapat Dihapus, Pemeriksaan Labor '+ b.caption AS respon, 0 AS responCode
