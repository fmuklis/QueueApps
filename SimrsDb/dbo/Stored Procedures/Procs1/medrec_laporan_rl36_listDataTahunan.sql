...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[medrec_laporan_rl36_listDataTahunan]
	...
	WITH dataSrc AS (
		SELECT a.idGolonganSpesialis, a.golonganSpesialis, ba.golonganOk
		  FROM dbo.masterOkGolonganSpesialis a
			   LEFT JOIN dbo.transaksiOrderOK b ON a.idGolonganSpesialis = b.idGolonganSpesialis AND YEAR(b.tglOperasi) = 2020
