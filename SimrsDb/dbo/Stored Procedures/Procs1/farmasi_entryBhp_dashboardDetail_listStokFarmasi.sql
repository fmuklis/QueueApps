...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =  = 
CREATE PROCEDURE [dbo].[farmasi_entryBhp_dashboardDetail_listStokFarmasi]
...
BEGIN
	...
	SELECT a.idObatDetail, c.namaBarang, a.kodeBatch, a.tglExpired, a.stok, c.namaSatuanObat, b.namaJenisStok AS lokasiStok
		  ,CASE
	 ...
	 WHERE a.stok >= 1 AND a.tglExpired > GETDATE() AND a.idRuangan IS NULL AND c.namaBarang LIKE '%'+ @search +'%'
