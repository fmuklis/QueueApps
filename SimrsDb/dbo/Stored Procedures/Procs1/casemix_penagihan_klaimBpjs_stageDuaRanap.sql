...
-- =============================================
CREATE PROCEDURE [dbo].[casemix_penagihan_klaimBpjs_stageDuaRanap]
...
BEGIN
	...
	/*UPDAE Status Billing*/
	UPDATE a
	   SET idStatusKlaim = CASE
								WHEN b.idStatusPendaftaran >= 99
									 THEN 5/*Grouping Stage 2*/
								ELSE 8/*Klaim Sementara*/
							END
