...
-- =============================================
CREATE PROCEDURE [dbo].[keuangan_kasir_billingResep_deletePembayaran]
...
BEGIN
	...
	Else
		Begin
			...
			Select 'Data Metode Pembayaran Resep Internal Berhasil Dihapus' As respon, 1 As responCode;
		End
END