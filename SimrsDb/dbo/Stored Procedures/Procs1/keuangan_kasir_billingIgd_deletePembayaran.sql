...
-- =============================================
CREATE PROCEDURE [dbo].[keuangan_kasir_billingIgd_deletePembayaran]
...
BEGIN
	...
	IF EXISTS(SELECT 1 FROM dbo.transaksiBillingPembayaran a
		...
		BEGIN
			SELECT 'Tidak Dapat Dihapus, Billing Gawat Darurat Telah Dibayar' As respon, 0 As responCode;
		END
	ELSE
		BEGIN
			...
			SELECT 'Data Pembayaran Billing Gawat Darurat Berhasil Dihapus' AS respon, 1 AS responCode;
		END
END