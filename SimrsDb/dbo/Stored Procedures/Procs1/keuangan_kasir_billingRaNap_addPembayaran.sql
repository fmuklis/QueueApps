...
-- =============================================
CREATE PROCEDURE [dbo].[keuangan_kasir_billingRaNap_addPembayaran]
	-- Add the parameters for the stored procedure here
	@idBilling bigint,
	@idMetodeBayar tinyint,
    @jumlahBayar money,
	@idUserEntry int
...
BEGIN
	...
	IF EXISTS(SELECT 1 FROM dbo.transaksiBillingPembayaran 
		...
		BEGIN
			...
			SELECT 'Data Cara Pembayaran Berhasil Diupdate' AS respon, 1 AS responCode;
		END
	ELSE
		BEGIN
