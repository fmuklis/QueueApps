...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[laporanRL32RaNap]
...
BEGIN
	...
	SELECT b.namaJenisPenjaminPembayaranPasien
	 ...
	 WHERE a.idJenisPendaftaran = 1/*IGD*/ And a.idJenisPerawatan = 1/*RaNap*/ And Year(a.tglDaftarPasien) = @tahun And Month(a.tglDaftarPasien) = @bulan
