...
-- =============================================
CREATE PROCEDURE [dbo].[keuangan_pembayaran_riwayat_listPembayaranRadiologi]
...
BEGIN
	...
	SELECT a.idBilling, a.idPendaftaranPasien, c.tglOrder, ba.noRM, ba.namaPasien, ba.tglLahirPasien, ba.umur, cb.NamaOperator 
	 ...
	 WHERE c.idRuanganTujuan=6 And a.idJenisBayar Is Not Null And Convert(date, a.tglBayar) Between @periodeAwal And @periodeAkhir
  ORDER BY a.tglBayar
END