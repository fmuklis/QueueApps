...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[medrec_laporan_kunjunganPasienRaNap_listData]
...
BEGIN
	...
	SET @query = 'SELECT tglDaftarPasien, noRM, namaPasien, namaJenisKelamin, tglLahirPasien, umur, namaJenisPenjaminInduk, diagnosaAwal, NamaOperator, namaRuangan, statusPasien
				    ...
				    FROM (Select a.tglDaftarPasien, b.noRM, b.namaPasien, b.namaJenisKelamin, b.tglLahirPasien, b.umur, da.namaJenisPenjaminInduk
								,dbo.diagnosaPasien(a.idPendaftaranPasien) As diagnosaAwal, e.NamaOperator, f.namaRuangan, c.namaStatusPasien
						   ...
						   Where a.idJenisPerawatan = 1/*RaNap*/ And Convert(date, a.tglDaftarPasien) Between @tglAwal And @tglAkhir @dynamicHere) As dataSet
						  @filter
