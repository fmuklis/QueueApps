...
-- =============================================
CREATE PROCEDURE [dbo].[farmasi_petugasFarmasi_stokOpnameDetail_editKoreksiStokOpname]
...
BEGIN
	...
	ELSE
		BEGIN
			...
			SELECT 'Data Koreksi Stok Barang Farmasi Berhasil Diupdate' AS respon, 1 AS responCode;
		END
END