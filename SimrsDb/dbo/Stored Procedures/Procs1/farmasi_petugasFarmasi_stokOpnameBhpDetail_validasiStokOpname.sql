...
-- =============================================
CREATE PROCEDURE [dbo].[farmasi_petugasFarmasi_stokOpnameBhpDetail_validasiStokOpname]
	...
	ELSE
		BEGIN TRY
			...
			UPDATE [dbo].[farmasiStokOpname]
			   SET [kodeStokOpnameBhp] = dbo.generate_nomorStokOpnameBhp(tanggalStokOpname)
