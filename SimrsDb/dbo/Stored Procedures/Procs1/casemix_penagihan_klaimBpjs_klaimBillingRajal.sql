...
-- =============================================
CREATE PROCEDURE [dbo].[casemix_penagihan_klaimBpjs_klaimBillingRajal]
...
BEGIN
	...
	/*Add Billing Tagihan Rajal BPJS*/
	INSERT INTO [dbo].[transaksiBillingHeader]
		  ...
		  SELECT a.idPendaftaranPasien
			...
			FROM dbo.transaksiPendaftaranPasien a
				 LEFT JOIN dbo.transaksiBillingHeader b ON a.idPendaftaranPasien = b.idPendaftaranPasien AND b.idJenisBilling = 1 /*RaJal*/
	...
	SELECT 'Tagihan Perawatan Rawat Jalan Siap Diklaim' AS respon, 1 AS responCode, @idBilling AS idBilling, @grouping AS [grouping];
END