...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[medrec_laporan_rl52_listData]
...
BEGIN
	...
	Select a.statusKunjungan, Count(a.idPendaftaranPasien) As Jumlah
	  From (SELECT a.idPendaftaranPasien
			 ...
			 WHERE a.idJenisPerawatan = 1/*Perawatan Rawat Inap*/ And Year(a.tglDaftarPasien) = @Tahun And Month(a.tglDaftarPasien) = @Bulan) a
