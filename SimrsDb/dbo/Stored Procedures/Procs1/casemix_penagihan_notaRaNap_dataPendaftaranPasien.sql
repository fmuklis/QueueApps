...
-- =============================================
CREATE PROCEDURE [dbo].[casemix_penagihan_notaRaNap_dataPendaftaranPasien]
...
BEGIN
	...
	SELECT b.tglDaftarPasien, b.tglKeluarPasien, ba.noRM, ba.namaPasien, ba.alamatPasien, ba.namaJenisKelamin, ba.tglLahirPasien, ba.umur
		  ...
		  , a.tarifChronic AS jumlahTarifChronic, b.noSEPRawatInap AS noSEP 
		  ,(SELECT CAST(MIN(tanggalMasuk) AS DATE) FROM dbo.transaksiPendaftaranPasienDetail WHERE idPendaftaranPasien = @idPendaftaranPasien) AS tglInap
