...
-- =============================================
CREATE PROCEDURE [dbo].[farmasi_petugasFarmasi_stokOpnameBhpDetail_dataStokOpname]
...
BEGIN
	...
	SELECT a.tanggalStokOpname, d.tahun, d.bulan, a.kodeStokOpnameBhp AS kodeStokOpname, c.namaPetugasFarmasi AS petugas, b.namaRuangan AS lokasiBhp
