...
-- =============================================
CREATE PROCEDURE [dbo].[keuangan_kasir_billingLaboratoriumPasienLuar_validasiPembayaran]
...
BEGIN
    ...
    -- Insert statements for procedure here
		Begin Try
			...
			/*Transaction Commit*/
			Commit Tran;
			Select 'Tagihan Billing Laboratorium Berhasil Dibayar' AS respon, 1 AS responCode;
		End Try
		Begin Catch
