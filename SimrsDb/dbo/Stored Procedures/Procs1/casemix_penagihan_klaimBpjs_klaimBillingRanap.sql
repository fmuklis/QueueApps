...
-- =============================================
CREATE PROCEDURE [dbo].[casemix_penagihan_klaimBpjs_klaimBillingRanap]
...
BEGIN
	...
	/*Add Billing Tagihan RaNap BPJS*/
	INSERT INTO [dbo].[transaksiBillingHeader]
		  ...
		  SELECT a.idPendaftaranPasien
			...
			FROM dbo.transaksiPendaftaranPasien a
				 LEFT JOIN dbo.transaksiBillingHeader b ON a.idPendaftaranPasien = b.idPendaftaranPasien AND b.idJenisBilling = 6/*Rawat inap*/
	...
	UPDATE dbo.transaksiPendaftaranPasien
	   SET noSEPRawatInap = TRIM(@sep)
	 WHERE idPendaftaranPasien = @idPendaftaranPasien AND (LEN(noSEPRawatInap) < 19 OR noSEPRawatInap IS NULL);
	...
	SELECT 'Tagihan Perawatan Rawat Inap Siap Diklaim' AS respon, 1 AS responCode, @idBilling AS idBilling, @grouping AS [grouping];
END