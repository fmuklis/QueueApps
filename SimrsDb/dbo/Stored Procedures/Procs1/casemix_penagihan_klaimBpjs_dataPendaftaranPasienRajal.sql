...
-- =============================================
CREATE PROCEDURE [dbo].[casemix_penagihan_klaimBpjs_dataPendaftaranPasienRajal]
...
BEGIN
	...
	If Exists(Select 1 From dbo.transaksiBillingHeader Where idBilling = @idBilling And idStatusKlaim <= 4/*Grouping 1*/)
		Begin
