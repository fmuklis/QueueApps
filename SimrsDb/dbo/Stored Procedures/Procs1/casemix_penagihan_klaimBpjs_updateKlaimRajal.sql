...
-- =============================================
CREATE PROCEDURE [dbo].[casemix_penagihan_klaimBpjs_updateKlaimRajal]
	-- Add the parameters for the stored procedure here
	@idBilling bigint,
	@kelasEksekutif bit,
	@tarifPoliEksekutif money,
...
BEGIN
	...
	DECLARE	@idPasien int = (Select idPasien From dbo.transaksiPendaftaranPasien Where idPendaftaranPasien = @idPendaftaran);
	...
	Begin Try
		...
		UPDATE [dbo].[transaksiBillingHeader]
		   SET [kelasEksekutif] = @kelasEksekutif
