...
-- =============================================
CREATE PROCEDURE [dbo].[farmasi_petugasFarmasi_stokOpnameBhpDetail_deleteItemStokOpname]
...
BEGIN
	...
	ELSE
		BEGIN
			...
			SELECT 'Item Tambah / Koreksi Stok BHP Berhasil Dihapus' AS respon, 1 AS responCode;
		END
END