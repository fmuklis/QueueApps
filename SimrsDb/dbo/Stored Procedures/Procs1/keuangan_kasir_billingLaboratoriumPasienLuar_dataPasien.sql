...
-- =============================================
CREATE PROCEDURE [dbo].[keuangan_kasir_billingLaboratoriumPasienLuar_dataPasien]
...
BEGIN
	...
	SELECT ba.namaPasien, ba.namaJenisKelamin, ba.tglLahir, ba.umur, ba.alamatPasien, ba.tlp, ba.DPJP, a.kodeBayar
		  ,bb.namaRuangan, d.discountTotal, a.diskonTunai AS diskonTunai, a.diskonPersen, b.nomorLabor
