...
-- =============================================
CREATE PROCEDURE [dbo].[keuangan_kasir_kwitansiRadiologi_dataPasien]
...
BEGIN
    ...
    SELECT ca.namaRuangan, bb.penjamin, cb.NamaOperator AS DPJP, ba.noRM, ba.namaPasien, ba.umur, ba.namaJenisKelamin
		  ,c.nomorRadiologi, a.kodeBayar, b.noReg, a.tglBayar, a.diskonTunai, a.diskonPersen, d.namaLengkap AS petugasKasir
		  ,dbo.calculator_totalTagihanRadiologi(a.idBilling) AS nilaiBayar, e.kota
