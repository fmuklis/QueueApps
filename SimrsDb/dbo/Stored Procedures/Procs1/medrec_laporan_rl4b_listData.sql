...
-- = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
CREATE PROCEDURE [dbo].[medrec_laporan_rl4b_listData]
...
BEGIN
	...
	DECLARE @dataSrc table(idGolonganSebabPenyakit int, idJenisKelaminPasien tinyint, golUmur varchar(50), meninggal bit, baru bit);
	...
	INSERT INTO @dataSrc
		 ...
		 SELECT ba.idGolonganSebabPenyakit, c.idJenisKelaminPasien
		  ...
		  WHERE a.idJenisPerawatan = 2/*RaJal*/ AND YEAR(a.tglDaftarPasien) = @tahun AND bb.penyebab = @penyebab;
	
	/*Select Data Report*/
	SELECT a.nomorDTD, a.nomorDaftarTerperinci, a.golonganSebabPenyakit, b.katA, c.katB, d.katC, e.katD, f.katE, g.katF
		  ,h.katG, i.katH, j.katI, k.katJ, l.katK, m.katL, n.katM, o.katN, p.katO, q.katP, r.katQ, s.katR, t.jmlBaruL
		  ,u.jmlBaruP, v.jmlKunjunganBaru, w.jmlKunjungan
	  FROM dbo.consGolonganSebabPenyakit a
		   OUTER APPLY (SELECT COUNT(*) AS katA
						 ...
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '>65Th') b
		   OUTER APPLY (SELECT COUNT(*) AS katB
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '>65Th') c
		   OUTER APPLY (SELECT COUNT(*) AS katC
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '45-65Th') d
		   OUTER APPLY (SELECT COUNT(*) AS katD
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '45-65Th') e
		   OUTER APPLY (SELECT COUNT(*) AS katE
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '25-44Th') f
		   OUTER APPLY (SELECT COUNT(*) AS katF
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '25-44Th') g
		   OUTER APPLY (SELECT COUNT(*) AS katG
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '15-24Th') h
		   OUTER APPLY (SELECT COUNT(*) AS katH
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '15-24Th') i
		   OUTER APPLY (SELECT COUNT(*) AS katI
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '5-14Th') j
		   OUTER APPLY (SELECT COUNT(*) AS katJ
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '5-14Th') k
		   OUTER APPLY (SELECT COUNT(*) AS katK
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '1-4Th') l
		   OUTER APPLY (SELECT COUNT(*) AS katL
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '1-4Th') m
		   OUTER APPLY (SELECT COUNT(*) AS katM
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '28hr-<1Th') n
		   OUTER APPLY (SELECT COUNT(*) AS katN
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '28hr-<1Th') o
		   OUTER APPLY (SELECT COUNT(*) AS katO
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '7-28Hr') p
		   OUTER APPLY (SELECT COUNT(*) AS katP
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '7-28Hr') q
		   OUTER APPLY (SELECT COUNT(*) AS katQ
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 0 AND xa.golUmur = '0-6Hr') r
		   OUTER APPLY (SELECT COUNT(*) AS katR
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.meninggal = 1 AND xa.golUmur = '0-6Hr') s
		   OUTER APPLY (SELECT COUNT(*) AS jmlBaruL
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.baru = 1 AND xa.idJenisKelaminPasien = 1) t
		   OUTER APPLY (SELECT COUNT(*) AS jmlBaruP
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit
							   AND xa.baru = 1 AND xa.idJenisKelaminPasien = 2) u
		   OUTER APPLY (SELECT COUNT(*) AS jmlKunjunganBaru
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit AND xa.baru = 1) v
		   OUTER APPLY (SELECT COUNT(*) AS jmlKunjungan
						  FROM @dataSrc xa
						 WHERE xa.idGolonganSebabPenyakit = a.idGolonganSebabPenyakit) w
